      ...
      <section className="grid margin-bottom-20">
        <div className="m-12 l-7 center">
          ...
          <div className="s-12 padding-2x background-white text-center">
            <h2 className="text-size-20 margin-bottom-10 text-strong text-uppercase text-dark">
              Company Address
            </h2>
            <p>Aviation Way 99</p>
            <p>Los Angeles, USA</p>

            <h2 className="text-size-20 margin-top-30 margin-bottom-10 text-strong text-uppercase text-dark">
              E-mail
            </h2>
            <p>
              <a
